 ...
 */
#define     CPU_FREQUENCY   4.000//7.3728////
...
#define     OWI_DELAY_A_STD_MODE    ((6 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY) 
#define     OWI_DELAY_B_STD_MODE    ((64 + OWI_DELAY_OFFSET_CYCLES)  * CPU_FREQUENCY)
#define     OWI_DELAY_C_STD_MODE    ((60 + OWI_DELAY_OFFSET_CYCLES)* CPU_FREQUENCY)
#define     OWI_DELAY_D_STD_MODE    ((10 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY)
#define     OWI_DELAY_E_STD_MODE    ((9 + OWI_DELAY_OFFSET_CYCLES)  * CPU_FREQUENCY)
#define     OWI_DELAY_F_STD_MODE    ((55 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY)
//#define     OWI_DELAY_G_STD_MODE  ((0   * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_H_STD_MODE    ((480 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY)
#define     OWI_DELAY_I_STD_MODE    ((70 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY)
#define     OWI_DELAY_J_STD_MODE    ((410 + OWI_DELAY_OFFSET_CYCLES) * CPU_FREQUENCY)
*/
...
// Bit timing delays in clock cycles (= us*clock freq in MHz).
#define     OWI_DELAY_A_STD_MODE    ((7   * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_B_STD_MODE    ((68  * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_C_STD_MODE    ((240  * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_D_STD_MODE    ((12  * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_E_STD_MODE    ((10   * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_F_STD_MODE    ((58  * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
//#define     OWI_DELAY_G_STD_MODE  ((0   * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_H_STD_MODE    ((700 * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_I_STD_MODE    ((75  * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
#define     OWI_DELAY_J_STD_MODE    ((420 * CPU_FREQUENCY) - OWI_DELAY_OFFSET_CYCLES)
